...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-primary-600 overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Rent vehicles</span>{' '}
                  <span className="block text-primary-200 xl:inline">made simple</span>
                </h1>
                <p className="mt-3 text-base text-primary-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Choose from our wide range of two-wheelers and four-wheelers. 
                  Transparent pricing, no hidden charges, and seamless booking experience.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1449824913935-59a10b8d2000?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
            alt="Vehicles"
          />
        </div>
      </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Book your vehicle in seconds with our streamlined booking process.
                </p>
              </div>
      ...
      {/* Smart Recommendations CTA Section */}
      <div className="bg-indigo-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">🎯 Get Smart Recommendations</span>
          </h2>
          <p className="mt-4 text-lg leading-6 text-indigo-200">
            Let our AI-powered system find the perfect vehicle for your trip. Tell us about your journey and get personalized recommendations with smart add-ons!
          </p>
